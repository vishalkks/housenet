...
class House(db.Model):
    ...
    def __init__(self, landlord_id, address, city, state, zip_code, google_maps_link, status, beds, baths, sq_ft, rent,
                 other_information):
    ...
    def to_dict(self):
        return dict({
            ...
            "status": self.status if self.status else HouseStatus.NOT_AVAILABLE,
            "beds": self.beds,
            "baths": self.baths,
            "sq_ft": self.sq_ft,
            "rent": self.rent,
...
class HouseLease(db.Model):
    ...
    def __init__(self, house_id, tenant_id, start_date, end_date, rent, security_deposit, lease_length, lease_type,
                 lease_file):
